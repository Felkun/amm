...
<div class="post">
	...
	print("<BR>Procediamo alla creazione del tuo utente PRIVATO!</p><BR>");
	if(isset($_SESSION['e1'])==1) { print($_SESSION['e1']); print("<BR>"); unset($_SESSION['e1']); }
	if(isset($_SESSION['e2'])==1) { print($_SESSION['e2']); print("<BR>"); unset($_SESSION['e2']); }
	if(isset($_SESSION['e3'])==1) { print($_SESSION['e3']); print("<BR>"); unset($_SESSION['e3']); }
	if(isset($_SESSION['e4'])==1) { print($_SESSION['e4']); print("<BR>"); unset($_SESSION['e4']); }
	if(isset($_SESSION['e5'])==1) { print($_SESSION['e5']); print("<BR>"); unset($_SESSION['e5']); }
	if(isset($_SESSION['e6'])==1) { print($_SESSION['e6']); print("<BR>"); unset($_SESSION['e6']); }
	if(isset($_SESSION['e7'])==1) { print($_SESSION['e7']); print("<BR>"); unset($_SESSION['e7']); }
	if(isset($_SESSION['e8'])==1) { print($_SESSION['e8']); print("<BR>"); unset($_SESSION['e8']); }
	if(isset($_SESSION['e9'])==1) { print($_SESSION['e9']); print("<BR>"); unset($_SESSION['e9']); }
	if(isset($_SESSION['e10'])==1) { print($_SESSION['e10']); print("<BR>"); unset($_SESSION['e10']); }
	if(isset($_SESSION['e11'])==1) { print($_SESSION['e11']); print("<BR>"); unset($_SESSION['e11']); }
	if(isset($_SESSION['e12'])==1) { print($_SESSION['e12']); print("<BR>"); unset($_SESSION['e12']); }
	if(isset($_SESSION['e13'])==1) { print($_SESSION['e13']); print("<BR>"); unset($_SESSION['e13']); }
	if(isset($_SESSION['e14'])==1) { print($_SESSION['e14']); print("<BR>"); unset($_SESSION['e14']); }
	print("<FORM ACTION=\"registerprivato.php\" METHOD=\"POST\">");
	...
	else { print("<span>Registrazione riuscita! Immetti i tuoi campi user e pass e usufruirai di tutti i nostri servizi!</span>"); unset($_SESSION['regriuscita']); }
	}
	?>
</div>
</div>
