...
<html>
    <head>
        ...
        <title>Metroid Prime - Storia</title>
    ...
    <body>
        <div id="container">
            ...
            <div id="body">
                <div id="submenu">
                    <ul>
                        <li><a class="active" href="story.php"><span class="menu">Metroid Prime</span></a></li>
                        <li><a href="story_hunters.php"><span class="menu">Metroid Prime Hunters</span></a></li>
                        <li><a href="story_echoes.php"><span class="menu">Metroid Prime 2: Echoes</span></a></li>
                        <li><a href="story_corruption.php"><span class="menu">Metroid Prime 3: Corruption</span></a></li>
                    </ul>
                </div>
                <br /><br />
