...
(strlen($_POST['partitaiva'])==0) ||
(strlen($_POST['ragionesociale'])==0)
...
//Fine controlli standard
//Aggiungi controlli aziendali
//Partita iva
if(!((is_numeric($_POST['partitaiva'])==1) && (strlen($_POST['partitaiva'])==11))) $stringaerrore15="Partita iva non valida!";
//Ragione sociale
if(strlen($_POST['ragionesociale'])<4) $stringaerrore16="Ragione Sociale non valida!";
//Fine controlli aziendali
...
(isset($stringaerrore15)==0) &&
(isset($stringaerrore16)==0)
)) {
if(isset($stringaerrore1)==1) $_SESSION['e1']=$stringaerrore1; //Passiamo alle variabili di sessione l'errore, se c'è.
...
if(isset($stringaerrore15)==1) $_SESSION['e15']=$stringaerrore15;
if(isset($stringaerrore16)==1) $_SESSION['e16']=$stringaerrore16;
} else {
if ($flagtelefono2==0) //se telefono 2 non esiste performa una query, altrimenti un'altra (con telefono2)
$sql="INSERT INTO cliente (username, password, email, nome, cognome, codicefiscale, datanascita, indirizzo, provincia, citta, cap, telefono1, partitaiva, ragionesociale)
VALUES
('$_POST[username]','$_POST[password]','$_POST[email]','$_POST[nome]','$_POST[cognome]','$_POST[codicefiscale]','$data','$_POST[indirizzo]','$_POST[provincia]','$_POST[citta]','$_POST[cap]','$_POST[telefono1]','$_POST[partitaiva]','$_POST[ragionesociale]')";
else
$sql="INSERT INTO cliente (username, password, email, nome, cognome, codicefiscale, datanascita, indirizzo, provincia, citta, cap, telefono1, telefono2, partitaiva, ragionesociale)
VALUES
('$_POST[username]','$_POST[password]','$_POST[email]','$_POST[nome]','$_POST[cognome]','$_POST[codicefiscale]','$data','$_POST[indirizzo]','$_POST[provincia]','$_POST[citta]','$_POST[cap]','$_POST[telefono1]','$_POST[telefono2]','$_POST[partitaiva]','$_POST[ragionesociale]')";
mysql_query($sql);
$_SESSION['regriuscita']=1; //Ci indica se la registrazione è riuscita oppure no.
}
header("Location: registrazioneazienda.php");
